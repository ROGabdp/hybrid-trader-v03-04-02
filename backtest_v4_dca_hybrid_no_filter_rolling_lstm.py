...
"""
================================================================================
V4 DCA + AI Hybrid 無濾網 Rolling LSTM 回測
(No Filter + Rolling LSTM Backtest)
================================================================================
...
RESULTS_PATH = os.path.join(PROJECT_PATH, 'results_backtest_v4_dca_hybrid_no_filter_rolling_lstm')
...
def main():
    ...
    print("=" * 70)
    print("V4 DCA + AI Hybrid 無濾網 Rolling LSTM 回測")
    print("(No Filter + Rolling LSTM Backtest)")
    print("=" * 70)
